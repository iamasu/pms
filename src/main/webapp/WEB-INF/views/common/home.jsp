<%-- 
    Document   : home
    Created on : Dec 28, 2015, 2:28:24 PM
    Author     : Asu
--%>
            ...
            $(function() {
                $("#users").jqGrid({
                    ...
                    colModel: [
                        ...
                        {name: "country", index: "country", width: 20, sortable: false, editable: true, edittype: 'select'}
                    ],
                    ...
                    useDataProxy: true,
                    editurl: "/admin.htm"
                }).jqGrid('navGrid', '#userpager', {edit: false, add: false, del: false, refresh: false, search: false},
                ...
                $("#users").jqGrid('navButtonAdd', '#userpager', {caption: 'Register User', onClickButton: function() {
