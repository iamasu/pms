package com.sitec.cpse.framework;
...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest freq, ServletResponse fres, FilterChain fc) throws IOException, ServletException {
        ...
        if (url.startsWith("/css/") || url.startsWith("/images/") || url.startsWith("/scripts/") || url.startsWith("/applets/")) {
        } else if ("/login.htm".equals(url)) {
            if (req.getSession().getAttribute("_user_cpse_") != null) {
